...
class TestManagePortfolioUseCase(unittest.TestCase):
    ...
    def test_should_update_portfolio_success(self):
        ...
        use_case.update_portfolio(self.portfolio)

        mock_portfolio_repository.update.assert_called_once_with(self.portfolio)
    ...
    def test_update_should_raise_exception_when_services_list_is_empty(self):
        mock_professional_repository = Mock(spec=ProfessionalRepository)
        mock_portfolio_repository = Mock(spec=PortfolioRepository)
        mock_service_repository = Mock(spec=ServiceRepository)
    ...
    def test_create_should_raise_exception_when_services_list_is_empty(self):
        mock_professional_repository = Mock(spec=ProfessionalRepository)
        mock_portfolio_repository = Mock(spec=PortfolioRepository)
        mock_service_repository = Mock(spec=ServiceRepository)
